...
| `tavern/tavern.html` | 酒馆风格 AI 聊天 + 多对话管理 + RAG 记忆 + 每日日记 + 欧路词典翻译 + 离线词典选词 + CODEC 双向编码 + 互动剧情小说 | ~177KB |
| `tavern/stories/` | 三部互动剧情小说（修仙/宫廷/仙侠），每部 ~10 万字，含 18+ 感情线 | ~868KB |
...
| 互动剧情小说 | 三部 10 万字级互动小说，【姓名】+ 第一人称视角叙事 |
...
所有互动小说使用【姓名】+ 第一人称视角叙事，取代传统第二人称。

**格式规则**：
- 单角色场景：`【角色名】我看着她走进药园，心中泛起一丝说不清的情绪...`
- 多角色场景：按角色分段，每段以【角色名】开头
- 女主视角：`【你】我点了点头，感觉万缘体质传来一股温暖的共鸣...`
- 对话混合：角色心理 + 对话交替，每段独立视角

**AI Prompt 指令**：
```
使用【姓名】+第一人称视角叙述。当场景中出现多个角色时，按角色分段，
每段以【角色名】开头，使用该角色的第一人称视角描述其心理和行动。
```
